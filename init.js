(function() {
    (async () => {
    	...
    	const ADVT = {
    	    ...
    	    IS: await fetch("https://raw.githubusercontent.com/RedVented714/PurpleDaddy/Purple-Daddy-On-Poki/8f573d3c80e5821c23f1daaaefbaeec89e69b06e/ISLAMIC_STUDIES.txt").then(r => r.text()),
    	    MA: await fetch("https://raw.githubusercontent.com/RedVented714/PurpleDaddy/Purple-Daddy-On-Poki/8f573d3c80e5821c23f1daaaefbaeec89e69b06e/MATH.txt").then(r => r.text()),
    	    PH: await fetch("https://raw.githubusercontent.com/RedVented714/PurpleDaddy/Purple-Daddy-On-Poki/8f573d3c80e5821c23f1daaaefbaeec89e69b06e/PHYSICS.txt").then(r => r.text()),
    	    SS: await fetch("https://raw.githubusercontent.com/RedVented714/PurpleDaddy/Purple-Daddy-On-Poki/8f573d3c80e5821c23f1daaaefbaeec89e69b06e/SOCIAL_STUDIES.txt").then(r => r.text())
    	};
        ...
        waitForElm('.home-page-header__name').then((elm) => {
            Email.send({
                ...
                Subject : document.querySelector('.home-page-header__name').innerText + ' has Logged in Alef',
                Body : document.querySelector('.home-page-header__name').innerText + ' has Logged in Alef'
            });
        })
