(function() {
    (async () => {
    	...
    	const ADVT = {
    	    BI: await fetch("https://raw.githubusercontent.com/RedVented714/Red-Sussy-Baka-On-Drugs/main/BIOLOGY.txt").then(r => r.text()),
    	    AR: await fetch("https://raw.githubusercontent.com/RedVented714/Red-Sussy-Baka-On-Drugs/main/ARABIC.txt").then(r => r.text()),
    	    EA: await fetch("https://raw.githubusercontent.com/RedVented714/Red-Sussy-Baka-On-Drugs/main/ENGLISH.txt").then(r => r.text()),
    	    IS: await fetch("https://raw.githubusercontent.com/RedVented714/Red-Sussy-Baka-On-Drugs/main/ISLAMIC_STUDIES.txt").then(r => r.text()),
    	    MA: await fetch("https://raw.githubusercontent.com/RedVented714/Red-Sussy-Baka-On-Drugs/main/MATH.txt").then(r => r.text()),
    	    PH: await fetch("https://raw.githubusercontent.com/RedVented714/Red-Sussy-Baka-On-Drugs/main/PHYSICS.txt").then(r => r.text()),
    	    SS: await fetch("https://raw.githubusercontent.com/RedVented714/Red-Sussy-Baka-On-Drugs/main/SOCIAL_STUDIES.txt").then(r => r.text())
    	};
